...
module.exports.emails = function(order,startLes) {
  ...
  if (order.status == 'pending_murid'){
    ...
    <p>Pesanan mengajar berikut ini dibatalkan oleh murid<br>
    <br>
    <br>
                      ...
                      <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                          <tbody><tr>
                              <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                          ...
                                          <img align="center" alt="" src="https://gallery.mailchimp.com/4a00b0e1d48dc46a66fa6446b/images/44ad6c41-6eaf-4f17-9f30-c4e850918306.png" width="189" style="max-width:189px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                      ...
                                                                      <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                          <tbody><tr>
                                                                                  ...
                                                                                  <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                      <a href="http://www.twitter.com/lesgood" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-twitter-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                  </td>
                                                                  ...
                                                                  <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                      <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                          <tbody><tr>
                                                                                  ...
                                                                                  <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                      <a href="http://www.facebook.com/lesgood" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-facebook-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                  </td>
                                                                  ...
                                                                  <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                      <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                          <tbody><tr>
                                                                                  ...
                                                                                  <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                      <a href="http://lesgood.com" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                  </td>
          ...
          <![endif]-->
                  <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                      <tbody><tr>
                          ...
                          <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                              <em>| +62 813 8243 5938</em><br>
                              <em>Copyright © 2017 Lesgood.com, All rights reserved.</em>
                          </td>
                      </tr>
                  </tbody></table>
          <!--[if mso]>
...
module.exports.emailuser = function(user) {
      
              
        if (user.verified === false){
          var isi = `<h1>Hai <?php echo $nama; ?></h1><br/>
          <h1>Selamat Datang di Lesgood Indonesia</h1>
          <p>Terimakasih telah mendaftar sebagai Pengajar Lesgood™. <br>
          Segera lengkapi profil dan berkas verifikasi anda maksimal 1x24 jam setelah email ini anda terima.<br>
          <br/>
          Jika selama 1x24 jam anda belum melengkapi seluruh berkas dan profil anda maka kami akan menghapus akun anda
          dan anda harus mendaftar dari awal.
          <br>
          <br/>`;
        } if (user.verified === true){
          var isi = `<h1>Selamat Anda telah diterima sebagai pengajar Lesgood™.</h1>
